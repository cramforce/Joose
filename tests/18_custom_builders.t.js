...
t.testCustomBuilders = function() {
    ...
    self.diag("custome properties in meta class")
    
    Class("TestMetaProperties", {
        isa: Joose.Class,
        
        properties: {
            customProp: function (paras, props) {
                var me = this;
                self.ok(paras, "received paras")
                self.ok(props, "received class properties")
                self.ok(paras.event1, "Received contents of paras")
    ...
    self.ok(TestMetaProperties, "TestMetaProperties class is here")
    self.ok(ThePropTestClass, "ThePropTestClass is here")
    self.ok(ThePropTestClass.meta.meta.isa(TestMeta), "ThePropTestClass' meta class is of the correct type")
    self.ok(ThePropTestClass.meta.can("test"), "Regular method is here")
    self.ok(!ThePropTestClass.meta.can("event1"), "No method event1")
    self.ok(ThePropTestClass.meta.can("customevent1"), "Method event1 generated by customProp that is called as method on the meta class arrived")
    self.ok(ThePropTestClass.meta.can("customevent2"), "Method event2 generated by customProp that is called as method on the meta class arrived")
    
    var o = new ThePropTestClass();
